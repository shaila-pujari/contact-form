...
if (isset($_POST['submit'])) {
    if ($_POST['captcha'] != $_SESSION['code']) {
        ...
        header('Location: success.html'); // redirects the user instantaneously.
...
<body>
    <h3 class="text-success" align="center">Please Fill Up Your Contact Detail</h3><br>
    <div class="container">
                ...
                <form class="form-horizontal" method="post">
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control form-check-input" id="name" name="name" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="mobno">DOB:</label>
                            <div class="col-sm-5">
                                <input type="date" class="form-control" id="txtDate" name="mobno" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="contact">About Yourself:</label>
                            <div class="col-sm-5">
